 ...
 */
public class _Deprecated_WordNetUtils {
	...
	public static String getSynonymsHead(String s){
		String[] cands = database.getBaseFormCandidates(s, SynsetType.VERB);
		if ( cands==null) return s;
		for (String ss: cands){
			return ss;
		}
		return s;
